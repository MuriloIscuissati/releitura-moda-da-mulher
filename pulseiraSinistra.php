    ...
    <div class="container mt-5">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="camisetas.php">Pulseiras</a></li>
                <li class="breadcrumb-item active" aria-current="page">Pulseira de Couro Sinistra</li>
            </ol>
        </nav>

        <div class="row">
            <div class="col-7">
                <img src="assets/images/produtos/pulseira-sinistra.jpg" alt="">
            </div>

            <div class="col-5">
                <h1>Pulseira de Couro Sinistra</h1>
                ...
                <h5 class="preco mt-3">R$29,99</h5>
