    ...
    <div class="container mt-5">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="camisetas.php">Chapelaria</a></li>
                <li class="breadcrumb-item active" aria-current="page">Chapéu Signature Synyster Gates</li>
            </ol>
        </nav>

        <div class="row">
            <div class="col-7">
                <img src="assets/images/produtos/chapeu-sinistro.jpg" alt="">
            </div>

            <div class="col-5">
                <h1>Chapéu Signature Synyster Gates</h1>
                ...
                <h5 class="preco mt-3">R$49,99</h5>
