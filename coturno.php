    ...
    <div class="container mt-5">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="camisetas.php">Calçados</a></li>
                <li class="breadcrumb-item active" aria-current="page">Bota Coturno Feminina</li>
            </ol>
        </nav>

        <div class="row">
            <div class="col-7">
                <img src="assets/images/produtos/coturno-feminina.jpg" alt="">
            </div>

            <div class="col-5">
                <h1>Bota Coturno Feminina</h1>
                ...
                <h5 class="preco mt-3">R$399,99</h5>
